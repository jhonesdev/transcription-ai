      ...
      <main className="flex flex-1 p-6 gap-6">
        <div className="flex flex-col flex-1 gap-4">
          <div className="grid grid-rows-2 gap-4 flex-1">
            ...
            <Textarea placeholder="Resposta da IA..." readOnly className="resize-none p-4 leading-relaxed" />
          </div>
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="transcription_prompt" className="h-20 resize-none leading-relaxed" placeholder="Inclua palavras-chave mencionadas no video separadas por virgula. " />
            </div>
